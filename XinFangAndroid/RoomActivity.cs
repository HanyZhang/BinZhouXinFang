...
namespace XinFangAndroid
{
    ...
    public class RoomActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            FindViewById<TextView>(Resource.Id.room_name).Text = "房间："+AgoraSettings.Current.RoomName;
        }
        ...
        public void RefreshDebug()
        {
            RunOnUiThread(() =>
            {
                FindViewById<TextView>(Resource.Id.debug_data).Text = $"本机id: {_localId}\n对方id: {_remoteId}";
            });
        }
        ...
        {
            InitializeAgoraEngine();//初始化SDK
            SetupVideoProfile();//创建频道
            SetupLocalVideo();//播放媒体
            JoinChannel();//加入频道
        }
        ...
        public override bool OnKeyDown([GeneratedEnum] Keycode keyCode, KeyEvent e)
        {
            ...
            {
                OnEncCallClicked(new View(this));
                return true;
            }
